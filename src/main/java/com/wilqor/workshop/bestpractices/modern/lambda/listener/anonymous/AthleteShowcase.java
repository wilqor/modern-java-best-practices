package com.wilqor.workshop.bestpractices.modern.lambda.listener.anonymous;
...
public class AthleteShowcase {
    ...
    public static void main(String[] args) throws WorkoutInterruptedException {
        ...
        WorkoutCompleteListener printingListener = new WorkoutCompleteListener() {
            @Override
            public void onWorkoutComplete(long caloriesBurned) {
                System.out.println("Good job, another: " + caloriesBurned + " calories burned!");
            }
        };
        WorkoutCompleteListener caloriesBurnedListener = new WorkoutCompleteListener() {
            @Override
            public void onWorkoutComplete(long caloriesBurned) {
                caloriesBurnedCounter.addCaloriesBurned(caloriesBurned);
            }
        };
        WorkoutCompleteListener workoutCompletedListener = new WorkoutCompleteListener() {
            @Override
            public void onWorkoutComplete(long caloriesBurned) {
